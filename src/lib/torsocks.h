...
#if (defined(__FreeBSD__) || defined(__darwin__) || defined(__NetBSD__))
extern TSOCKS_LIBC_DECL(kqueue, LIBC_KQUEUE_RET_TYPE, LIBC_KQUEUE_SIG)
TSOCKS_DECL(kqueue, LIBC_KQUEUE_RET_TYPE, LIBC_KQUEUE_SIG)
#define LIBC_KQUEUE_DECL LIBC_KQUEUE_RET_TYPE \
		LIBC_KQUEUE_NAME(LIBC_KQUEUE_SIG)
extern TSOCKS_LIBC_DECL(kevent, LIBC_KEVENT_RET_TYPE, LIBC_KEVENT_SIG)
TSOCKS_DECL(kevent, LIBC_KEVENT_RET_TYPE, LIBC_KEVENT_SIG)
#define LIBC_KEVENT_DECL LIBC_KEVENT_RET_TYPE \
		LIBC_KEVENT_NAME(LIBC_KEVENT_SIG)

#if defined(__NetBSD__)
extern TSOCKS_LIBC_DECL(kevent1, LIBC_KEVENT1_RET_TYPE, LIBC_KEVENT1_SIG)
TSOCKS_DECL(kevent1, LIBC_KEVENT1_RET_TYPE, LIBC_KEVENT1_SIG)
#define LIBC_KEVENT1_DECL LIBC_KEVENT1_RET_TYPE \
		LIBC_KEVENT1_NAME(LIBC_KEVENT1_SIG)
#endif /* __NetBSD__ */
#if defined(__darwin__)
extern TSOCKS_LIBC_DECL(kevent64, LIBC_KEVENT64_RET_TYPE, LIBC_KEVENT64_SIG)
TSOCKS_DECL(kevent64, LIBC_KEVENT64_RET_TYPE, LIBC_KEVENT64_SIG)
#define LIBC_KEVENT64_DECL LIBC_KEVENT64_RET_TYPE \
		LIBC_KEVENT64_NAME(LIBC_KEVENT64_SIG)
#endif /* __darwin__ */
#endif /* __FreeBSD__, __darwin__, __NetBSD__ */
